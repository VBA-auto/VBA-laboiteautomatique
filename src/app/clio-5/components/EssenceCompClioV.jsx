                  ...
                  <div className="mt-2">
                    <div className="px-4 mb-2">
                      ...
                      <h1 className="text-[15px]">
                        Calculateur Renault Clio 5 - 1.3 Essence
                      </h1>
                    </div>
                    ...
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[15px]">
                        Module de commande (calculateur) Renault Clio 5 Essence
                      </p>
                    </div>
                    <div className="px-4 mb-3">
                    ...
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[15px]">Clio 5 - 1.3 Essence</p>
                    </div>
                    <div className="px-4 mb-3">
                      <p className="text-[14px] text-gray-400">
                        Info complémentaire
                      </p>
                      <p className="text-[15px]">Clio 5 à partir de 2015</p>
                    </div>
                    <div className="px-4 mb-3">
                ...
                <div className="md:flex md:px-5 px-4 py-1 justify-between">
                  <div className="md:w-1/2 flex items-center gap-5">
                    ...
                    <div className="">
                      ...
                      <h1 className="my-1">Clio 5 - 1.3 Essence</h1>
                    </div>
                  </div>
...
export default EssenceCompClioV;
