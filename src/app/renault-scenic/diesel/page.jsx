...
const pageDescription =
  "Commander ici votre calculateur pour boîte automatique EDC (DC4) pour Renault Scenic 1.5 Diesel";
const HeadingText = "Calculateur, boîte automatique Renault Scenic 1.5 Diesel";
  ...
  return (
    <main>
      ...
      <div className="relative produits">
        <Head>
          <title>
            Calculateur, boîte automatique Renault Scenic 1.5 Diesel
          </title>
          ...
          <div className="orderPrevPage group rounded-xl shadow-2xl md:p-8 transition-color bg-white/90 accent_color md:w-3/5 lg:w-3/5 xl:w-5/12 text-center">
            ...
            <div className="text-center">
              <p className="mb-4">
                ...
                Scénic Diesel Boite automatique DC4 (getrag 6DCT250)
              </p>
              ...
              <div className="flex justify-center">
                <div style={{ width: "140px" }} className="homeButtons">
                  <Link href="https://buy.stripe.com/5kA2bM7FSfVJ7iE15b">
