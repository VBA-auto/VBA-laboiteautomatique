      ...
      <section className="produits rounded-lg mt-8">
        <div className="">
          <div className="container mx-auto mb-2.5">
                  ...
                  <div className="mt-2">
                    ...
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[15px]">
                        Module de commande (calculateur) Renault Captur <br />{" "}
                        Diesel
                      </p>
                    </div>
                    <div className="px-4 mb-3">
            ...
            <DieComModal
              brand="Renault"
              model="Captur 1.5 Diesel"
              imagesSlide={imagesSlide}
              newPayLink="https://buy.stripe.com/3cs5nY6BOfVJ5aw29B"
              reconditionedPayLink="https://buy.stripe.com/3cI14o9TY19g3jp4Ku9sk36"
              stockModel="Renault Captur"
              stockType="diesel"
            />
