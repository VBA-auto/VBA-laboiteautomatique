...
const pageDescription =
  "Commander ici votre calculateur pour boîte automatique EDC (DC4) pour Renault Megane 1.5 Diesel";
const HeadingText = "Calculateur, boîte automatique Renault Megane 1.5 Diesel";
  ...
  return (
    <main>
      ...
      <div className="relative produits">
        <Head>
          <title>
            Calculateur, boîte automatique Renault Megane 1.5 Diesel
          </title>
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center">
                <div style={{ width: "140px" }} className="homeButtons">
                  <Link href="https://buy.stripe.com/fZecQq5xKbFt0UgcNR">
