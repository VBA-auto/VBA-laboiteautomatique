...
const SingleVehicleView = () => {
  ...
  return (
    <main>
      <Head>
        <title>Calculateur Renault scenic 3 1.5 Diesel</title>
        <meta name="title" content="Calculateur Renault scenic 3 1.5 Diesel" />
        <meta
          name="description"
          content="Trouver ici votre calculateur pour boite automatique pour renault scenic 3 1.5 Diesel programmation incluse"
        />
      </Head>
      <SubHeader />
      <Header />
