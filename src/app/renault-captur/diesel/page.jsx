...
const pageDescription =
  "Commander ici votre calculateur pour boîte automatique EDC (DC4) pour Renault Captur 1.5 Diesel";
const HeadingText =
  "Commander ici votre calculateur pour boîte automatique EDC (DC4) pour Renault Captur 1.5 Diesel";
  ...
  return (
    <main>
      ...
      <div className="relative produits">
        <Head>
          <title>Calculateur boite automatique EDC Renault Captur Diesel</title>
        ...
        <div style={{ display: "none" }}>
          <h1>
            ...
            pour Renault Captur 1.5 Diesel
          </h1>
        </div>
          ...
          <div className="orderPrevPage group rounded-md shadow-2xl md:p-8 transition-color  bg-white/90 accent_color  md:w-3/5 lg:w-3/5 xl:w-5/12 text-center">
            ...
            <div className="text-center">
              <p className="mb-4">
                ...
                Captur Diesel Boite automatique DC4 (getrag 6DCT250)
              </p>
