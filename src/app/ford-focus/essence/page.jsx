...
const pageDescription =
  "Commander ici votre calculateur pour boîte automatique EDC (DC4) pour Ford Focus Essence";
const HeadingText = "Calculateur, boîte automatique Ford focus Essence";
  ...
  return (
    <main>
      ...
      <div className="relative produits">
        <Head>
          <title>Calculateur, boîte automatique Ford focus Essence</title>
          <meta name="description" content={pageDescription} />
          <meta name="headline" content={HeadingText} />
        </Head>
        <div className=" w-full  justify-center flex  z-20 relative">
          <div className="orderPrevPage group rounded-md shadow-2xl md:p-8 transition-color  bg-white/90 accent_color  md:w-3/5 lg:w-3/5 xl:w-5/12 text-center">
            ...
            <div className="text-center">
              <p className="mb-4">
                ...
                Focus Essence Boite automatique DC4 (getrag 6DCT250)
              </p>
              ...
              <div className="flex justify-center">
                <div style={{ width: "140px" }} className="homeButtons">
                  <Link href="https://buy.stripe.com/fZe17I5xKfVJ1Yk3dl">
