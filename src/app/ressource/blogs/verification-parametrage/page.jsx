              ...
              <div className="mt-5 mb-16">
                ...
                <div className="mb-5">
                  ...
                  <p className="mt-2">
                    ...
                    transmettre la puissance. Ils reflètent directement l’état
                    de l’embrayage.
                  </p>
                  <p className="mt-2">
                  ...
                  <p className="mt-2">
                    ...
                    qu’un embrayage défectueux tombe sous <b>0.20</b>, signalant
                    des glissements et des à coups.{" "}
                  </p>
                </div>
                ...
                <div className="mb-5">
                  <h2 className="mt-5 font-[600]">
                    4. Identifier la qualité de l’embrayage avec le coefficient
                    de friction (facultatif)
                  </h2>
                  <p className="mt-2">
                    ...
                    <b>0.4</b>, l’embrayage est en excellent état. En revanche,
                    une friction inférieure à <b>0.2</b> révèle un embrayage usé
                    ou glissant, nécessitant une intervention rapide.
                  </p>
                </div>
                ...
                <div className="mb-5">
                  ...
                  <p className="mt-2">
                    <b>9.5 mm</b> pour l’embrayage 2 (K2), qui gère les rapports
                    2, 4 et 6.
                  </p>
                  <p className="mt-2">
                ...
                <div className="mb-5">
                  ...
                  <p className="mt-2">
                    ...
                    touche. Si vous n’avez pas fait de calibrage des points de
                    touche, ceux-ci doivent fluctuer naturellement et augmenter
                    au-delà de 8.5 mm pour l’embrayage 1 et au-delà de 9.5 mm
                    pour l’embrayage 2.
                  </p>
                </div>
