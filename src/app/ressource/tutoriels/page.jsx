          ...
          <main className="pt-[60px] pb-[80px]">
            <div className="container mx-auto">
              ...
              <div className="mx-auto mt-8 md:px-0">
                <div className="">
                  <div className="blogsCard grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
                    {/* Static Content 1 */}
                    <div className="carouselItems flex">
                      <div className=" w-full h-full">
                        <div className="blog-main w-full h-full">
                          <div className="">
                              ...
                              <div className="content-container  mt-3">
                                <Link href="/ressource/blogs/calibrage">
                                  <p className="text-sm text-justify">
                                    ...
                                    au calculateur: version diag – logiciel –
                                    calibrage.
                                  </p>
                            ...
                            <Link href="/ressource/blogs/differentes-boites-DC4">
                              <div className="border  rounded-md p-2">
                                ...
                                <div className="content-container mt-2">
                                  <p className="text-sm text-justify">
                                    Quelles sont les différents de boites EDC
                                    ete comment les trouver en fonction de leur
                                    véhicule.
                                  </p>
                                </div>
                          ...
                          <div className="">
                            ...
                            <Link href="/ressource/blogs/presentation-vba">
                              <div className="border  rounded-md p-2">
                                ...
                                <div className="content-container mt-2">
                                  <p className=" text-sm text-justify">
                                    VBA calculateur se spécialise dans la vente
                                    de calculateur de boite automatique pour
                                    Renault et Audi.
                                  </p>
                                </div>
                                <div className="flex justify-between mt-3">
                          ...
                          <div className="">
                            ...
                            <Link href="/ressource/blogs/test-embrayage-edc">
                              <div className="border  rounded-md p-2">
                                ...
                                <div className="content-container mt-2">
                                  <p className=" text-sm text-justify">
                                    Comment verifier l&apos;état de
                                    l&apos;embrayage pour une Megane 3, Scenic
                                    3, Clio 4 ou Captur.
                                  </p>
                                </div>
                                <div className="flex justify-between mt-3">
                          ...
                          <div className="">
                            ...
                            <div className="border  rounded-md p-2">
                              ...
                              <Link href="/ressource/blogs/remplacement-calculateur">
                                <div className="content-container mt-3 ">
                                  <p className=" text-sm text-justify">
                                    Remplacement d&apos;un calculateur EDC (DC4/
                                    GETRAG 6DCT250): explication démontage et
                                    remontage.
                                  </p>
                                </div>
