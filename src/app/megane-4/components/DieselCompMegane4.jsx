                  ...
                  <div className="mt-2">
                    <div className="px-4 mb-2">
                      ...
                      <h1 className="text-[15px]">
                        Calculateur Renault Mégane 4 - 1.5 Diesel
                      </h1>
                    </div>
                    ...
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[15px]">
                        Module de commande (calculateur) Renault Mégane 4 Diesel
                      </p>
                    </div>
                    <div className="px-4 mb-3">
                    ...
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[15px]">Mégane 4 - 1.5 Diesel</p>
                    </div>
                    <div className="px-4 mb-3">
                ...
                <div className="md:flex md:px-5 px-4 py-1 justify-between">
                  <div className="md:w-1/2 flex items-center gap-5">
                    ...
                    <div className="">
                      ...
                      <h1 className="my-1">Mégane 4 - 1.5 Diesel</h1>
                    </div>
                  </div>
...
export default DieselCompMegane4;
