...
// THIS COMPONENT IS FOR MANAGING OLD STOCK (CARS, REF CODES, BLOG COMMENTS, PROMO)
// IT HAS BEEN REPLACED BY StockManage.jsx FOR BETTER ORGANIZATION AND MAINTAINABILITY
...
export default function OldStockManage({ handleLogout }) {
