            ...
            <main className="flex  flex-col z-20 relative">
              ...
              <div className="productscards grid grid-cols-3 justify-center gap-6 mt-5">
                  ...
                  <Link href="/captur">
                    <div className="flex items-center border rounded-md gap-3 mt-[20px] hover:bg-gray-100">
                      ...
                      <div className="w-2/3">
                        ...
                        <p className="text-sm">a partir de 2008 to 2012 </p>
                      </div>
                    </div>
                  </Link>
                ...
                <div className="lg:w-full rounded-md shadow-sm p-5 bg-white/50 singleProductCard accent_color">
                  ...
                  <SimpleSlider />
                  <Link href="/clio">
                    <div className="flex items-center border rounded-md gap-3 mt-[20px]">
                      <div className="w-1/3">
                        <Image
                          width={110}
                          height={100}
                      ...
                      <div className="w-2/3">
                        <h2 className=" text-[22px] font-medium text-strt  text-[#374151] hover:text-blue-400">
                          Renault Clio IV
                        </h2>
                        <p className="text-sm">a partir de 2008 to 2012 </p>
                      </div>
                ...
                <div className="lg:w-full rounded-md shadow-sm p-5 bg-white/50 singleProductCard accent_color">
                  ...
                  <Link href="/megane">
                    <div className="flex items-center border rounded-md gap-3 mt-[20px]">
                      ...
                      <div className="w-2/3">
                        <h2 className="text-[22px] font-medium text-start transition-transform text-[#374151] hover:text-blue-400">
                          Renault Mégane
                        </h2>
                        <p className="text-sm">a partir de 2008 to 2012 </p>
                      </div>
