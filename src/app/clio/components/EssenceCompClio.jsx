...
const EssenceCompClio = () => {
  ...
  return (
    <main>
      <Head>
        <title>Calculateur Renault Clio IV 1.2 Essence</title>
      ...
      <section className="produits rounded-lg mt-8">
        <div className="">
          <div className="container mx-auto mb-2.5">
            ...
            <DieComModal
              brand="Renault"
              model="Clio IV 1.2 Essence"
              imagesSlide={imagesSlide}
              newPayLink="https://buy.stripe.com/dR6bMmaS44d132oaG8"
              reconditionedPayLink="https://buy.stripe.com/00wfZieae4lsf27b8S9sk37"
...
export default EssenceCompClio;
