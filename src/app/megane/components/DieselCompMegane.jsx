...
const DieselCompMegane = () => {
  ...
  return (
    <main>
      <Head>
        <title>Calculateur Renault Clio 4 1.5 Diesel</title>
        <meta name="title" content="Calculateur Renault Clio 4 1.5 Diesel" />
        <meta
          name="description"
      ...
      <section className="produits rounded-lg mt-8">
        <div className="">
          <div className="container mx-auto mb-2.5">
            ...
            <DieComModal
              brand="Renault"
              model="Mégane III  1.5 Diesel"
              imagesSlide={imagesSlide}
              newPayLink="https://buy.stripe.com/3csaIi1hugZN0Ug7tZ"
              reconditionedPayLink="https://buy.stripe.com/eVq4gA0jodW2aLRccW9sk3a"
...
export default DieselCompMegane;
