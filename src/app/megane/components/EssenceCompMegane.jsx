  ...
  return (
    <main>
      <Head>
        ...
        <meta
          name="title"
          content="Calculateur, boîte automatique Renault Megane Essence"
        />
        <meta
          name="description"
          content="Trouver ici votre calculateur pour boite automatique pour Renault megane 3 1.2 Essence programmation incluse "
        />
      </Head>
      ...
      <section className="produits rounded-lg mt-8">
        <div className="">
          <div className="container mx-auto mb-2.5">
            ...
            <DieComModal
              brand="Renault"
              model="Mégane III  1.2 Essence"
              imagesSlide={imagesSlide}
              newPayLink="https://buy.stripe.com/7sI9Ee7FS8thgTe29E"
              reconditionedPayLink="https://buy.stripe.com/4gM9AUaY205c3jp3Gq9sk39"
              stockModel="Renault Megane"
              stockType="essence"
            />
...
export default EssenceCompMegane;
