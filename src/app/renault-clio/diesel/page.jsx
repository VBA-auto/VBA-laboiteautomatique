...
const pageDescription =
  "Commander ici votre calculateur pour boîte automatique EDC (DC4) pour Renault Clio 4 1.5 Diesel";
const HeadingText = "Calculateur, boîte automatique Renault Clio 4 Diesel";
  ...
  return (
    <main>
      ...
      <div className="relative produits">
        <Head>
          <title>Calculateur, boîte automatique Renault Clio 4 Diesel</title>
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center ">
                <div style={{ width: "140px" }} className="homeButtons">
                  <Link href="https://buy.stripe.com/4gw7w69O07pd1YkcNQ">
