...
const pageDescription =
  "Commander ici votre calculateur pour boîte automatique EDC (DC4) pour Renault Clio 4 1.2 Essence";
const HeadingText = "Calculateur, boîte automatique Renault Clio 4 Essence";

export default function RenaultClioSingle() {
  return (
    <main>
      <SubHeader />
      <Header />
      <div className="relative produits">
        <Head>
          <title>Calculateur, boîte automatique Renault Clio 4 Essence</title>
          <meta name="description" content={pageDescription} />
          <meta name="headline" content={HeadingText} />
        </Head>
        <div className=" w-full items-center justify-center flex  flex-col z-20 relative">
          <div className="orderPrevPage group rounded-xl shadow-2xl md:p-8 transition-color bg-white/90 accent_color  md:w-3/5 lg:w-3/5 xl:w-5/12 text-center">
            ...
            <div className="text-center">
              <p className="mb-4">
                ...
                Clio IV Essence Boite automatique DC4 (getrag 6DCT250)
              </p>
              ...
              <div className="flex justify-center">
                <div style={{ width: "140px" }} className="homeButtons">
                  <Link href="https://buy.stripe.com/dR69Eed0c10PcCY013">
