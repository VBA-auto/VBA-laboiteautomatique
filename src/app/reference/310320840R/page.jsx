            ...
            <div className="md:flex mt-10 p-4 items-center gap-2 border border-gray-200  rounded-lg bg-white/50">
              ...
              <div className="md:w-3/4 ">
                ...
                <p className="text-justify text-[15px] my-3">
                  Vous trouverez ici le calculateur Renault 310320840R, un
                  module de commande pour boîte automatique EDC destiné aux
                  modèles Clio 4 et Captur, en versions Essence et Diesel.
                  Associé aux boîtes DC4005 et DC4006, il assure la gestion de
                  la transmission. Ce calculateur peut être livré vierge ou déjà
                  programmé (Plug & Play) directement à partir de
                  l’immatriculation ou du VIN, prêt à être installé. Référence
                  d’origine Renault (310320840R), garanti 12 mois. <br />{" "}
