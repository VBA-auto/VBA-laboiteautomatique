  ...
  return (
    <main>
      ...
      <section className="produits">
        <Head>
          <title>
            Calculateur boîte automatique EDC Renault référence 310321716R
          </title>
          <meta
            name="description"
            content="Commandez ici votre Calculateur pour boîte automatique EDC Renault référence 310321716R, programmation incluse. Vérifiez disponibilité."
          />
        </Head>
            ...
            <div className="md:flex  justify-center ">
              <div className="md:w-[400px] p-4  bg-white rounded-tl-[5px]">
                <p className="text-[14px] mt-1">
                  ...
                  <span className="text-gray-700">310321716R</span>{" "}
                </p>
              ...
              <div className="md:w-[400px] bg-white rounded-tr-[5px] border-l-[1px] md:pb-0 pb-5">
                ...
                <div className="mt-2">
                  ...
                  <div className="px-4 mb-2">
                    ...
                    <p className="text-[15px]">Twingo 3 à partir de 2018</p>
                  </div>
                  <div className="px-4 mb-2">
                    <p className="text-[14px] text-gray-400">
                      Info complémentaire{" "}
                    </p>
                    <p className="text-[15px]">code boite: DC4002</p>
                  </div>
                  <div className="px-4 mb-2">
                    <p className="text-[14px] text-gray-400">Référence OE</p>
                    <p className="text-[15px]">310310321716R</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="md:flex px-5 py-1 justify-between">
                <div className="md:w-1/2 flex items-center gap-5">
                  ...
                  <div className="">
                    ...
                    <h1 className="my-1">Calculateur Twingo 3</h1>
                  </div>
                </div>
            ...
            <div className="modal-box bg-white">
              ...
              <div className="">
                ...
                <div className="text-center">
                  <Link
                    target="_blank"
                    href="https://buy.stripe.com/14k03Ef8k38X7iEbKo"
                  >
