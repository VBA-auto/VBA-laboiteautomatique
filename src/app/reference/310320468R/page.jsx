  ...
  return (
    <main>
      ...
      <section className="produits">
        <Head>
          <title>
            Calculateur boîte automatique EDC Renault référence 310320468R
          </title>
          <meta
            name="description"
            content="Commandez ici votre Calculateur pour boîte automatique EDC Renault référence 310320468R, programmation incluse. Vérifiez disponibilité."
          />
        </Head>
            ...
            <div className="md:flex  justify-center ">
              <div className="md:w-[400px] p-4  bg-white rounded-tl-[5px]">
                <p className="text-[14px] mt-1">
                  ...
                  <span className="text-gray-700">310320468R</span>{" "}
                </p>
              ...
              <div className="md:w-[400px] bg-white rounded-tr-[5px] border-l-[1px] md:pb-0 pb-5">
                ...
                <div className="mt-2">
                  ...
                  <div className="px-4 mb-2">
                    ...
                    <p className="text-[15px]">
                      310320468R - 310320756R - A2C30743000
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="modal-box bg-white">
              ...
              <div className="">
                ...
                <div className="text-center">
                  <Link
                    target="_blank"
                    href="https://buy.stripe.com/9AQ6s2aS49xl6eA7ur"
                  >
