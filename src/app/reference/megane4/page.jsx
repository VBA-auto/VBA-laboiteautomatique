  ...
  return (
    <main>
      ...
      <section className="produits">
        <Head>
          <title>
            Calculateur boîte automatique EDC Renault référence Megane IV
          </title>
          <meta
            name="description"
            content="Commandez ici votre Calculateur pour boîte automatique EDC Renault référence Megane IV, programmation incluse. Vérifiez disponibilité."
          />
        </Head>
            ...
            <div className="md:flex  justify-center ">
              <div className="md:w-[400px] p-4  bg-white rounded-tl-[5px]">
                <p className="text-[14px] mt-1">
                  ...
                  <span className="text-gray-700">Megane IV</span>{" "}
                </p>
              ...
              <div className="md:w-[400px] bg-white rounded-tr-[5px] border-l-[1px] md:pb-0 pb-5">
                <div className="flex justify-between items-center px-4 pt-4 pb-1">
                  ...
                  <div className="">
                    <NewVehicleRef
                      modelName="Calculateur Megane IV (1.5 Diesel)"
                      refCode="megane4"
                ...
                <div className="mt-2">
                  <div className="px-4 mb-2">
                    ...
                    <h1 className="text-[15px]">
                      Calculateur Megane IV (1.5 Diesel)
                    </h1>
                  </div>
                  <div className="px-4 mb-2">
                  ...
                  <div className="px-4 mb-2">
                    ...
                    <p className="text-[15px]">A2C73768908/09/10/11/12 00K00</p>
                  </div>
                </div>
              </div>
            </div>
