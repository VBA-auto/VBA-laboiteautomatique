            ...
            <div className="md:flex mt-10 p-4 items-center gap-2 border border-gray-200  rounded-lg bg-white/50">
              ...
              <div className="md:w-3/4 ">
                ...
                <p className="text-justify text-[15px] my-3">
                  Vous trouverez ici le calculateur Renault A2C30743003, un
                  module de commande pour boîte automatique EDC destiné aux Clio
                  4 et Captur les plus récentes. Associé aux boîtes DC4015 et
                  DC4016, il assure la gestion électronique de la transmission.
                  Ce calculateur peut être livré vierge ou déjà programmé (Plug
                  & Play) directement via VIN ou immatriculation, prêt à être
                  monté. Références d’origine Renault (A2C30743003 – 01K00),
                ...
                <div className="carsef grid  md:grid-cols-8 grid-cols-3 md:mt-0 mt-3  items-center justify-start">
                  <p className="text-[14px] text-gray-700 italic mt-2 underline">
                    <Link href="/reference/A2C30743003">A2C30743003</Link>
                  </p>
                  <p className="text-[14px] text-gray-700 italic mt-2 underline">
