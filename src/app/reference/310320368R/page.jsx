  ...
  return (
    <main>
      ...
      <section className="produits">
        <Head>
          <title>
            Calculateur boîte automatique EDC Renault référence 310320368R
          </title>
          <meta
            name="description"
            content="Commandez ici votre Calculateur pour boîte automatique EDC Renault référence 310320368R, programmation incluse. Vérifiez disponibilité."
          />
        </Head>
            ...
            <div className="md:flex  justify-center ">
              <div className="md:w-[400px] p-4  bg-white rounded-tl-[5px]">
                <p className="text-[14px] mt-1">
                  ...
                  <span className="text-gray-700">310320368R</span>{" "}
                </p>
                ...
                <div className="mt-2">
                  <div className="px-4 mb-2">
                    ...
                    <h1 className="text-[15px]">
                      Calculateur Clio 4 - 1.2 Essence
                    </h1>
                  </div>
                  <div className="px-4 mb-2">
                  ...
                  <div className="px-4 mb-2">
                    ...
                    <p className="text-[15px]">Clio 4 - Code moteur H5F412</p>
                  </div>
                  <div className="px-4 mb-2">
                    <p className="text-[14px] text-gray-400">Référence OE</p>
                    <p className="text-[15px]">01 K00 - 310320368R</p>
                  </div>
                </div>
              </div>
            </div>
