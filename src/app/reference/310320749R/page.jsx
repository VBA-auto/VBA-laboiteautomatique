                    ...
                    <>
                      <div className="">
                        <h1 className="md:text-lg text-base md:mb-0 mb-2 text-gray-700 font-semibold flex items-center gap-2">
                          310320749R - Calculateur Scénic 3 - Megane 3
                        </h1>
                      </div>
                    </>
                  </div>
            ...
            <div className="md:flex mt-10 p-4 items-center gap-2 border border-gray-200  rounded-lg bg-white/50">
              ...
              <div className="md:w-3/4 ">
                ...
                <p className="text-justify text-[15px] my-3">
                  Calculateur <strong>EDC premium</strong> pour Renault{" "}
                  <strong>Scénic 3</strong> et <strong>Mégane 3</strong> haut de
                  gamme. Ce <strong>module évolué</strong> intègre les dernières
                  technologies de transmission avec gestion intelligente du{" "}
                  <strong>couple</strong>. Compatible moteurs{" "}
                  <strong>diesel dCi</strong> et systèmes{" "}
                  <strong>4-Control</strong>. Programmation{" "}
                  <strong>sur mesure</strong> incluse avec calibrage
                  d&apos;usine. <strong>Garantie totale 12 mois</strong> avec
                  service premium. Installation par réseau agréé recommandée.
                  Vérifiez équipements de votre véhicule avant achat.
                </p>
