            ...
            <div className="md:flex mt-10 p-4 items-center gap-2 border border-gray-200  rounded-lg bg-white/50">
              ...
              <div className="md:w-3/4 ">
                ...
                <p className="text-justify text-[15px] my-3">
                  Vous trouverez ici le calculateur Renault 310320749R, un
                  module de commande pour boîte automatique EDC destiné aux
                  Scénic 3 et Mégane 3 équipés du moteur 1.5 Diesel. Associé aux
                  boîtes DC4000 et DC4001, il assure la gestion électronique de
                  la transmission à double embrayage sur ces modèles. Ce
                  calculateur peut être livré vierge ou programmé (Plug & Play)
                  directement à partir de l’immatriculation ou du numéro de
