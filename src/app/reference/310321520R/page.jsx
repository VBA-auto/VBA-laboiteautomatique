  ...
  return (
    <main>
      ...
      <section className="produits">
        <Head>
          <title>
            Calculateur boîte automatique EDC Renault référence 310321520R
          </title>
          <meta
            name="description"
            content="Commandez ici votre Calculateur pour boîte automatique EDC Renault référence 310321520R, programmation incluse. Vérifiez disponibilité.."
          />
        </Head>
            ...
            <div className="md:flex  justify-center ">
              <div className="md:w-[400px] p-4  bg-white rounded-tl-[5px]">
                <p className="text-[14px] mt-1">
                  ...
                  <span className="text-gray-700">310321520R</span>{" "}
                </p>
                <div className="md:w-full  mt-5 mb-8">
              ...
              <div className="md:w-[400px] bg-white rounded-tr-[5px] border-l-[1px] md:pb-0 pb-5">
                <div className="flex justify-between items-center px-4 pt-4 pb-1">
                  ...
                  <div className="">
                    <NewVehicleRef
                      modelName="Calculateur Renault Clio 4 GT- Clio 4"
                      refCode="310321520R"
                ...
                <div className="mt-2">
                  ...
                  <div className="px-4 mb-2">
                    ...
                    <p className="text-[15px]">
                      Clio 4 - 1.2 Essence - Clio 4 GT Essence
                    </p>
                  </div>
                  <div className="px-4 mb-2">
                    ...
                    <p className="text-[15px]">
                      Clio 4 à partir de 2012 - Clio 4 GT Essence
                    </p>
                  </div>
                  <div className="px-4 mb-2">
