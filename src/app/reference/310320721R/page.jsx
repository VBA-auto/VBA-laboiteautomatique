  ...
  return (
    <main>
      ...
      <section className="produits">
        <Head>
          <title>
            Calculateur boîte automatique EDC Renault référence 310320721R
          </title>
          <meta
            name="description"
            content="Commandez ici votre Calculateur pour boîte automatique EDC Renault référence 310320721R, programmation incluse. Vérifiez disponibilité."
          />
        </Head>
            ...
            <div className="md:flex  justify-center ">
              <div className="md:w-[400px] p-4  bg-white rounded-tl-[5px]">
                <p className="text-[14px] mt-1">
                  ...
                  <span className="text-gray-700">310320721R</span>{" "}
                </p>
              ...
              <div className="md:w-[400px] bg-white rounded-tr-[5px] border-l-[1px] md:pb-0 pb-5">
                ...
                <div className="mt-2">
                  <div className="px-4 mb-2">
                    ...
                    <h1 className="text-[15px]">Calculateur Captur</h1>
                  </div>
                  <div className="px-4 mb-2">
                  ...
                  <div className="px-4 mb-2">
                    ...
                    <p className="text-[15px]">
                      Clio 4 et Captur (Essence et Diesel)
                    </p>
                  </div>
                  <div className="px-4 mb-2">
                  ...
                  <div className="px-4 mb-2">
                    ...
                    <p className="text-[15px]">310320721R</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="md:flex px-5 py-1 justify-between">
                <div className="md:w-1/2 flex items-center gap-5">
                  ...
                  <div className="">
                    ...
                    <h1 className="my-1">Calculateur Captur</h1>
                  </div>
                </div>
            ...
            <div className="modal-box bg-white">
              ...
              <div className="">
                ...
                <div className="text-center">
                  <Link
                    target="_blank"
                    href="https://buy.stripe.com/eVa6s2d0c38XcCY6qj"
                  >
