            ...
            <div className="md:flex mt-10 p-4 items-center gap-2 border border-gray-200  rounded-lg bg-white/50">
              ...
              <div className="md:w-3/4 ">
                ...
                <p className="text-justify text-[15px] my-3">
                  Vous trouverez ici le calculateur Renault 310321706R, un
                  module de commande pour boîte automatique EDC destiné aux
                  modèles Kadjar à partir de 2018. Compatible avec la boîte DW5,
                  il équipe également certains modèles Clio 5, Mégane 4, Captur
                  2 et Talisman. Ce calculateur est livré vierge et doit
                  obligatoirement être programmé avant installation en
                  concession, à partir du VIN ou de l’immatriculation.
                  Références d’origine Renault (310321706R – 0260001060 –
                  2510261400), garanti 12 mois.
                </p>
