            ...
            <div className="md:flex mt-10 p-4 items-center gap-2 border border-gray-200  rounded-lg bg-white/50">
              ...
              <div className="md:w-3/4 ">
                ...
                <p className="text-justify text-[15px] my-3">
                  Module <strong>EDC SUV premium</strong> développé pour Renault{" "}
                  <strong>Kadjar</strong> équipé. Ce{" "}
                  <strong>calculateur haut de gamme</strong> gère parfaitement
                  les transmissions intégrales et tractions. Compatible avec
                  systèmes
                  <strong> 4x4 intelligents</strong> et moteurs{" "}
                  <strong>Energy</strong> dernière génération. Technologie{" "}
                  <strong>Terrain Response</strong> avec adaptation automatique
                  aux conditions. Installation <strong>certifiée SUV</strong>{" "}
                  avec programmation tout-terrain incluse.{" "}
                  <strong>Garantie constructeur 12 mois </strong>
                  usage intensif. Vérifiez options 4x4 de votre Kadjar.
                </p>
