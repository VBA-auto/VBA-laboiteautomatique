                    ...
                    <>
                      <div className="">
                        <h1 className="md:text-lg text-base md:mb-0 mb-2 text-gray-700 font-semibold flex items-center gap-2">
                          310320892R - Calculateur Captur - Megane 3
                        </h1>
                      </div>
                    </>
                  </div>
                    ...
                    <div className="w-full mx-auto">
                      <div className="flex justify-between">
                        ...
                        <div className="relative  rounded-full px-6 w-full flex justify-end gap-5">
                          <NewVehicleRef
                            modelName="Calculateur Captur - Megane 3"
                            refCode="310320892R"
                          />
                        </div>
                      </div>
            ...
            <div className="md:flex mt-10 p-4 items-center gap-2 border border-gray-200  rounded-lg bg-white/50">
              ...
              <div className="md:w-3/4 ">
                ...
                <p className="text-justify text-[15px] my-3">
                  Module <strong>EDC cross-platform</strong> pour Renault{" "}
                  <strong>Captur</strong> et <strong>Mégane 3</strong>. Ce{" "}
                  <strong>calculateur polyvalent</strong> assure une
                  compatibilité parfaite entre crossover urbain et berline
                  familiale. Moteurs <strong>essence turbo</strong> et{" "}
                  <strong>diesel éco</strong> supportés avec optimisation
                  spécifique. Programmation <strong>intelligente</strong> avec
                  adaptation automatique du style de conduite.{" "}
                  <strong>Garantie étendue 12 mois</strong> multi-véhicule.
                  Installation certifiée par réseau agréé. Contrôle préalable
                  indispensable pour validation technique complète.
                </p>
