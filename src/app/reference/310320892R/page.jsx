            ...
            <div className="md:flex mt-10 p-4 items-center gap-2 border border-gray-200  rounded-lg bg-white/50">
              ...
              <div className="md:w-3/4 ">
                ...
                <p className="text-justify text-[15px] my-3">
                  Vous trouverez ici le calculateur Renault 310320892R, un
                  module de commande pour boîte automatique EDC destiné aux
                  modèles Captur et Mégane 3, en motorisations 1.2 Essence et
                  1.5 Diesel. Associé aux boîtes DC4000, DC4005 et DC4006, il
                  assure la gestion de la transmission à double embrayage. Ce
                  ...
                  Renault (310320892R – 310320565R – 310320721R), garanti 12
                  mois.
                </p>
