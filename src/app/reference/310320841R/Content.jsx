  ...
  return (
    <main>
      <section className="produits rounded-lg">
        <Head>
          <title>
            Calculateur boîte automatique EDC Renault référence 310320841R
          </title>
          <meta
            name="description"
            content="Commandez ici votre Calculateur pour boîte automatique EDC Renault référence 310320841R, programmation incluse. Vérifiez disponibilité."
          />
        </Head>
            ...
            <div className="md:flex  justify-center">
              <div className="md:w-[600px] p-4  bg-white rounded-tl-[5px]">
                <p className="text-[14px] mt-1">
                  ...
                  <span className="text-gray-700">310320841R</span>{" "}
                </p>
              ...
              <div className="md:w-[600px] bg-white rounded-tr-[5px] border-l-[1px] md:pb-0 pb-5 py-3">
                <div className="mt-2">
                  <div className="px-4 mb-2">
                    ...
                    <h1 className="text-[15px]">Calculateur Scenic - Megane 4</h1>
                  </div>
                  <div className="px-4 mb-2">
            ...
            <div className="modal-box bg-white">
              ...
              <div className="">
                ...
                <div className="text-center">
                  <Link
                    target="_blank"
                    href="https://buy.stripe.com/14k5nY1hu24TbyUdSI"
                  >
