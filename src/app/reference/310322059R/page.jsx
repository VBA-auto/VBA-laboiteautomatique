  ...
  return (
    <main>
      ...
      <section className="produits">
        <Head>
          <title>
            Calculateur boîte automatique EDC Renault référence 310322059R
          </title>
          <meta
            name="description"
            content="Commandez ici votre Calculateur pour boîte automatique EDC Renault référence 310322059R, programmation incluse. Vérifiez disponibilité."
          />
        </Head>
            ...
            <div className="md:flex  justify-center ">
              <div className="md:w-[400px] p-4  bg-white rounded-tl-[5px]">
                <p className="text-[14px] mt-1">
                  ...
                  <span className="text-gray-700">310322059R</span>{" "}
                </p>
              ...
              <div className="md:flex px-5 py-1 justify-between">
                <div className="md:w-1/2 flex items-center gap-5">
                  ...
                  <div className="">
                    ...
                    <h1 className="my-1">Calculateur Clio V</h1>
                  </div>
                </div>
              ...
              <div className="">
                ...
                <div className="mt-3">
                  <div className="flex justify-between mb-2">
                    ...
                    <p className="text-[#2C80EF] text-[15px]">1210 €</p>
                  </div>
                  <div className="flex justify-between mb-2">
                ...
                <div className="mt-5">
                  ...
                  <div className="flex justify-between my-2 ">
                    ...
                    {showCoupon ? (
                      ...
                      <p className="text-[#2C80EF] text-[15px]">1229 €</p>
                    )}
                  </div>
                </div>
                <div className="text-center">
                  <Link
                    target="_blank"
                    href="https://buy.stripe.com/eVa7w60dqgZN9qMcOp"
                  >
