...
const pageDescription =
  "Commander ici votre calculateur pour boîte automatique EDC (DC4) pour Renault Fluence 1.5 Diesel";
const HeadingText = "Calculateur, boîte automatique Renault Fluence 1.5 Diesel";
  ...
  return (
    <main>
      ...
      <div className="relative produits">
        <Head>
          <title>
            Calculateur, boîte automatique Renault Fluence 1.5 Diesel
          </title>
        ...
        <div className=" w-full items-center justify-center flex  flex-col  z-20 relative">
          <div className="orderPrevPage group rounded-xl shadow-2xl md:p-8 transition-color bg-white/90 accent_color md:w-3/5 lg:w-3/5 xl:w-5/12 text-center">
            ...
            <h2 className="text-[30px]xl font-semibold pb-2">
              Calculateur Renault Fluence
            </h2>
            <div className="text-center">
              <p className="mb-4">
                Module de commande (calculateur) pour boite automatique Renault
                Fluence Diesel Boite automatique DC4 (getrag 6DCT250)
              </p>
              ...
              <div className="flex justify-center">
                <div style={{ width: "140px" }} className="homeButtons">
                  <Link href="https://buy.stripe.com/14k8Aa0dqbFtdH23dk">
